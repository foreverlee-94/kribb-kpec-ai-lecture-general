...
export const aiHistorySlides: Slide[] = [
  {
    ...
    body: '기호주의 AI의 태동부터 오늘날의 거대 언어모델과 에이전트까지, 지난 60여 년의 굵직한 흐름을 훑어봅니다. 아래 그래프는 AI에 대한 사회적 관심·투자와 실제 성능 수준이 시대별로 어떻게 오르내렸는지를 개념적으로 보여줍니다 — 이 굴곡을 먼저 짚고, 이어지는 슬라이드에서 각 구간을 하나씩 살펴보겠습니다.',
    diagram: 'timeline',
    bullets: [
